# Important: This code comes from the django-grappelli project
# (http://github.com/sehmaschine/django-grappelli/). Credit (and
# bug reports...) should be given its original authors.
